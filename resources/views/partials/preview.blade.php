                ...
                <div class="absolute top-[4.2cm] right-[1cm] w-[11.8cm] h-[7.3cm] bg-[#00712D] rounded-[50px] flex flex-col items-center justify-center px-6">
                    ...
                    <template x-if="item.isMember">
                        <div class="flex flex-col items-center w-full leading-none">
                            <div class="text-white font-[900] text-[16px] uppercase mb-1 tracking-widest">PROMO MEMBER</div>
                            ...
                            <div class="text-white flex flex-col items-center">
                                ...
                                <div class="flex items-center"><span class="text-[14px] font-extrabold mr-1">Rp</span><span class="text-[#FFCC00] font-[900] text-[38px]" x-text="item.nonMemberPrice"></span></div>
                            </div>
                        </div>
                    </template>
                    ...
                    <template x-if="!item.isMember">
                        <div class="flex items-start justify-center leading-none mt-4">
                            ...
                            <span class="text-[#FFCC00] font-[900] text-[125px] tracking-[-8px] leading-[0.7]" x-text="item.newPrice"></span>
                        </div>
                    </template>
